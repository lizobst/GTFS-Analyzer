        ...
        with tab2:
            ...
            if map_type == "Routes Overview":
                ...
                with st.spinner("Generating map..."):
                    ...
                    st.components.v1.html(system_map._repr_html_(), height=1000)
            else:
                with st.spinner("Generating heatmap..."):
                    heatmap = create_stop_heatmap(gtfs_data)
                    st.components.v1.html(heatmap._repr_html_(), height=1000)
        ...
        with tab3:
            ...
            if selected_route_display:
                ...
                with st.spinner("Loading route details..."):
                    ...
                    st.components.v1.html(route_map._repr_html_(), height=900)
